    ...
    return(
      <>
        <div className="items_right">
          <div className="noise" data-id="0" style={{background:this.state.numemer==0 &&this.state.Istruess? "black":false}} onClick={(e)=>{
            this.Change(e);
            console.log(e)
          }}>
          ...
          <div className="chosse_music" data-id="1" style={{background:this.state.numemer==1 &&!this.state.Istruess? "black":false}} onClick={(e)=>{
            this.Change(e);
          }}>
